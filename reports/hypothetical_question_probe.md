...
| DHSS vital-statistics summary | `What DHSS vital statistics data is indexed?` | Deterministic coverage summary for statewide Table 1 values and county Table 16A values from official DHSS PDFs. |
...
| DHSS county vital statistics | `How many births and deaths were in Boone County in 2023?` | Deterministic county aggregate lookup with resident births/deaths, natural increase, rates, and annual-report citation. |
| DHSS county vital ranking | `Which county had the most resident deaths in 2023?` | Deterministic ranking over county Table 16A resident-death rows. |
