...
- Source usefulness probe: `scripts/test_source_usefulness.py` with 38 representative source-family questions that verify expected answer terms plus at least one official HTTP source/download link per sourced answer.
...
- DOR aggregate report rows: 39,486 aggregate records from 16 official public report files, including 2016-2025 county Sales/Use taxable-sales ZIPs
