...
CASES = [
    ...
    },
    {
        ...
        "contains": ["SOS election exact lookup layer", "3 official election-return PDF", "782 contests", "1,604 candidate/ballot result row"],
        "citation_contains": ["Missouri Secretary of State official election returns", "sos_elections_index", "2024GeneralElection.pdf"],
        "no_source_rows": True,
        "model": "deterministic_public_lookup",
    },
    {
    ...
    },
    {
        ...
        "contains": ["January 2026", "Revenue Information", "PR%202026-01%20Detail.xlsx"],
        "citation_contains": ["Office of Administration Budget and Planning", "oa_budget_index"],
        "source_rows_contains": ["revenue_detail", "January 2026", "PR%202026-01%20Detail.xlsx"],
        "model": "deterministic_public_lookup",
    },
    {
