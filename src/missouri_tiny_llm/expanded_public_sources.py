...
DEDICATED_PARSER_NOTES = {
    ...
    "dhss": (
        ...
        "DHSS BRFSS statewide prevalence workbook, and DHSS WIC county/municipality aggregates; "
        "MOPHIMS/MICA numeric values, county-level BRFSS values, births/deaths, and hospitalizations still need separate aggregate parsers."
    ),
    "long_term_care": (
