...
DEDICATED_PARSER_NOTES = {
    "dese": (
        ...
        "2025-2026 DESE school-finance transfer PDFs; MCDS numeric dashboard values, full accountability "
        "calculations, staff rows, budgets, audits, and broader finance tables still need separate parsers."
    ),
    "dhss": (
        ...
        "selected DHSS MOPHIMS statewide ProfileBuilder rows, and DHSS WIC county/municipality aggregates; broader MOPHIMS/MICA query values, county-level BRFSS values, "
        "county-level births/deaths, and hospitalizations still need separate aggregate parsers."
    ),
    "long_term_care": (
