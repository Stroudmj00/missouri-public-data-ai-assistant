...
PUBLIC_SOURCE_CATALOG: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "use_case": "Exact metadata lookup for accountability/APR/MSIP, Core Data/MOSIS file layouts and code sets, school finance, assessment, and special-education resource links; selected School Directory and selected 2025 APR ranking exact lookups are also implemented.",
        "risk": "Resource metadata only for the broader school-data layer; selected APR ranking rows are parsed from published lowest-5% PDFs but full MCDS numeric dashboard values, accountability calculations, staff rows, and finance tables still need dedicated parsers. Contact/person fields from directory PDFs are suppressed.",
    },
    {
        "key": "dhss",
        ...
        "use_case": "Exact metadata lookup for county profiles, MOPHIMS/MICA tools, BRFSS, births/deaths, hospitalizations/PAS, county-level study, vital-statistics FOCUS reports, and surveillance dashboard links; selected communicable-disease, BRFSS statewide prevalence, statewide vital-statistics, and WIC aggregate lookup is also implemented.",
        "risk": "Resource metadata only for the broader health layer; MOPHIMS/MICA numeric values, county-level BRFSS values, county-level births/deaths, vital-record certificates, patient-level records, and hospital discharge records still need aggregate parsers with suppression handling.",
    },
    {
        "key": "mshp_sac",
