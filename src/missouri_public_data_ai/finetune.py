"""Historical LoRA fine-tuning helpers for the Missouri Public Data AI Assistant."""
...
from missouri_public_data_ai.baseline_inference import estimate_model_download_mb
...
def update_model_card_after_training(summary: dict[str, Any]) -> None:
    content = f"""# Training Run Model Card

## Historical Training State

This report describes a historical LoRA adapter trained on generated aggregate/source Missouri public-data QA pairs. It is not the current runtime model card for the Missouri Public Data AI Assistant.
...
"""
    (PROJECT_ROOT / "reports" / f"{summary['run_id']}_model_card.md").write_text(content, encoding="utf-8")
