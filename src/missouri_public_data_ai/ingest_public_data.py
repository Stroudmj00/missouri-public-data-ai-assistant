...
Missouri Public Data AI Assistant Aggregate QA

## Intended Use

Educational case study for testing source-grounded assistant behavior over sanitized Missouri public-data aggregates.
