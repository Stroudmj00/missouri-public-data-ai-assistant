...
def build_data_mo_hospital_index(force: bool = False) -> dict[str, Any]:
    ...
    payload = {
        ...
        "sanitization_note": (
            ...
            "or administrator-name fields in assistant answers or source-row previews."
        ),
        "records": records,
    }
...
class DataMoHospitalIndex:
    ...
    def coverage_answer(self, question: str) -> dict[str, Any]:
        ...
        answer = (
            ...
            "The assistant does not display hospital address, phone, fax, or administrator-name fields."
        )
        return {
            "question": question,
            "answer": answer,
