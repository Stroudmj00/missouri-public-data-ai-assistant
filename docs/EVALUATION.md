...
- DOR aggregate report index: 22 official public report files and 45,472 parsed aggregate records
...
- Source usefulness probe: 40 representative source-family questions checked for a non-guardrail answer, expected answer terms, and at least one official HTTP source/download link
