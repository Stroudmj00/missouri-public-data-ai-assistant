...
- Source usefulness probe: 39 representative source-family questions passed with at least one official HTTP source or download link per sourced answer
...
- DOR aggregate report index: 20 official public report files and 45,460 aggregate records parsed locally
