...
- Source usefulness probe: 38 representative source-family questions passed with at least one official HTTP source or download link per sourced answer
...
- DOR aggregate report index: 16 official public report files and 39,486 aggregate records parsed locally
