...
- Selected 2025 Missouri assessment aggregate CSV rows for statewide plus selected district/school performance-level lookup
...
- Selected `data.mo.gov` Missouri Farmers' Markets rows for county counts, city lookups, public listing details, websites, addresses, and top-county rankings with contact-name and email fields suppressed
...
- Source usefulness probe: 43 representative source-family questions passed with at least one public HTTP source or download link per sourced answer
...
- DOR aggregate report index: 29 official public report files and 45,948 aggregate records parsed locally
...
- DESE assessment index: 1,584,738 public 2025 source rows streamed; 10,528 selected All Students aggregate rows kept; raw 197 MB CSV not saved
...
- data.mo.gov Missouri Farmers' Markets index: 280 public directory listing rows across 90 counties and 195 cities
