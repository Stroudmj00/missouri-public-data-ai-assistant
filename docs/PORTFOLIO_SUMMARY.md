...
Built a source-grounded Missouri public-data chatbot case study using existing indexed public finance, health, education, transportation, ethics, elections, utility, PSC, OA Budget, agriculture, cannabis-regulation, child-care, and school-data sources. The project combines deterministic lookup, route/ranking diagnostics, citations, guardrails, aggregate QA generation, baseline evaluation, LoRA fine-tuning, and documented data boundaries.
