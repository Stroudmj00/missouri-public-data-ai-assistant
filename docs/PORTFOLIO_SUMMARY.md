...
- Deterministic lookup for exact indexed public records such as MAP totals, contracts, election returns, utility providers, PSC report metadata, and selected cannabis-regulation facts
