...
Built a reproducible tiny-LLM case study using public Missouri finance and healthcare datasets, with a CUDA-enabled local training environment, aggregate QA generation, baseline evaluation, LoRA fine-tuning, deterministic MAP lookup for indexed public records, and documented data boundaries.
...
- Deterministic lookup for exact indexed MAP records
