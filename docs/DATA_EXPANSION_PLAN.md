...
| Tax and revenue | [DOR public reports](https://dor.mo.gov/public-reports/) | Parse a first exact aggregate layer for 2016-2025 county taxable sales, FY22-FY25 food tax by political subdivision, business-location counts, vehicle counts, licensed-driver totals, dealer counts by county/type, and SIC location counts. | Moderate: suppressed cells, noncounty taxable-sales reports, Working Family Tax Credit PDFs, and broader DOR report families still need source-specific parsers. |
