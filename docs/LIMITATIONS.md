...
The selected data.mo.gov DNR water index is not a full DNR environmental or water-quality parser. It currently covers the Consumer Confidence Report public drinking-water system listing with PWSID, system name, and county. The separate DNR data/e-services resource metadata index can point to public links for water permits, MoCWIS, drinking-water tools, impaired waters, water-quality resources, GIS/map viewers, air-emissions tools, E-Start, WIMS, GeoSTRAT, energy data, forms, and public notices. A selected DNR impaired-waters parser now extracts 549 listing rows from the proposed 2024-2026 Section 303(d) listed-waters PDF for county, pollutant, waterbody, and high-priority TMDL questions. It does not parse broader numeric water-quality values, permits, emissions, waste sites, geospatial layers, live advisories, drinking-water safety, recreation safety, medical guidance, or legal compliance conclusions.
