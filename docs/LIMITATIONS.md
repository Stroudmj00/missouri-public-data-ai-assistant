...
The DOR aggregate report index is intentionally selective. It currently parses 2016-2025 county Sales/Use taxable sales, FY22-FY25 Food Tax by Political Subdivision PDFs, a 2016 business-location report, vehicle counts as of 2017-12-31, licensed-driver totals as of 2024-11-14, dealer counts by county/type, and SIC location-count snapshots. Other DOR public reports, broader tax-credit/report families, Working Family Tax Credit PDFs, and noncounty taxable-sales reports need their own parsers before the chatbot should give exact values for them. When DOR marks a food-tax cell suppressed because six or fewer businesses exist, the chatbot reports that suppression instead of estimating a value.
