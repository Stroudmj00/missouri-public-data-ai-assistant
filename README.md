...
- exact aggregate DOR lookup for 2016-2025 county taxable sales, FY22-FY25 food tax by political subdivision, business locations, vehicle counts, licensed-driver totals, dealer counts, and SIC location counts
...
| DOR aggregate report index | 20 official public report files, 45,460 aggregate records |
...
| Behavior tests | 293 chatbot cases passed |
| Source usefulness probe | 39 representative source-family questions passed with official HTTP source/download links |
...
| [DOR public reports](https://dor.mo.gov/public-reports/) | 2016-2025 county taxable sales, FY22-FY25 Food Tax by Political Subdivision PDFs, 2016 business-location report, vehicle counts, licensed-driver totals, dealer counts, and SIC location reports | Indexed locally for cited aggregate revenue, food-tax, vehicle, driver, dealer, and SIC lookup |
...
- DOR source report downloads: about 7.3 MB; local parsed DOR JSON index: about 25 MB
