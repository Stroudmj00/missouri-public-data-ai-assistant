...
| [MSHP SAC Data](https://www.mshp.dps.mo.gov/MSHPWeb/SAC/data_960grid.html) and [Traffic Safety Compendium](https://www.mshp.dps.mo.gov/MSHPWeb/SAC/Compendium/TrafficCompendium.html) | Aggregate crash severity, rates, circumstances, factor Excel files, and selected 2023 Compendium statewide/factor tables | Indexed locally for cited crash-statistic lookup, including latest selected 2023 fatality, injury, speed, alcohol/drug, young-driver, older-driver, commercial-vehicle, motorcycle, school-bus, pedestrian/pedalcycle, work-zone, and deer-involved crash questions |
