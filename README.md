...
- exact selected DHSS vital-statistics aggregate lookup for statewide Table 1 births, deaths, natural increase, infant deaths, marriages, divorces, and population values, plus county Table 16A resident/recorded births, deaths, natural increase, and rates
...
| Contract document text index | 50 public PDFs, 16.619 MB downloaded locally in the sample capped run |
...
| DHSS vital-statistics aggregate index | 21 statewide Table 1 rows from the 2023 Vital Statistics FOCUS PDF, covering 2013, 2022, and 2023, plus 116 Table 16A county/state rows from the 2023 annual Missouri Vital Statistics PDF |
...
| [DHSS Vital Statistics FOCUS](https://health.mo.gov/data/focus/), [2023 Vital Statistics FOCUS PDF](https://health.mo.gov/data/focus/pdf/2023-focus.pdf), and [2023 annual Missouri Vital Statistics PDF](https://health.mo.gov/data/vitalstatistics/mvs23/2023MissouriVitalStatistics.pdf) | Statewide Table 1 vital-statistics counts/rates and county Table 16A resident/recorded births, deaths, natural increase, and rates | Indexed locally for cited statewide and county aggregate answers; vital-record certificates, person records, city/demographic slices, and MOPHIMS/MICA query results are not parsed |
...
- DHSS Vital Statistics FOCUS PDF, annual Missouri Vital Statistics PDF, and local aggregate index: about 3.4 MB local source/index footprint
